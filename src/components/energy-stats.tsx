...
// import { Zap, TrendingUp, TrendingDown, DollarSign, Lightbulb, Battery, Gauge, Leaf } from "lucide-react";
...
//   const { t } = useLanguage();
//   const energyData = useSelector((state: RootState) => state.app.energyData[0]);
...
//         const isGoodChange = (stat.titleKey === 'lossPercentage' || stat.titleKey === 'co2Emissions') ? !isPositive : isPositive;
